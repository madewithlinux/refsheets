...
Value: \verb|0xA0B0C0D0|\\
  ...
  % \begin{tabular}{r r r}
  % idx: & little & big \\
  %   0 & \verb|0xD0| & \verb|0xA0| \\
  %   1 & \verb|0xC0| & \verb|0xB0| \\
  %   2 & \verb|0xB0| & \verb|0xC0| \\
  %   3 & \verb|0xA0| & \verb|0xD0| \\
  % \end{tabular}
  % \\
...
% \includegraphics[width=0.493\columnwidth]{Big-Endian}
% \includegraphics[width=0.493\columnwidth]{Little-Endian}
% take up space after bottom of picture
% \vspace{-20px} 
