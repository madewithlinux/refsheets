...
\zzz{AC Resistors and Capacitors}
$$R||\frac{1}{Cs}
...
\includegraphics[width=\columnwidth]{../ecen325/mos_n.png}
\begin{center}
\vspace{-10px}
\textbf{NMOS}
\end{center}
\end{minipage}
\begin{minipage}{0.49\columnwidth}
\includegraphics[width=\columnwidth]{../ecen325/mos_p.png}
\begin{center}
\vspace{-10px}
\textbf{PMOS}
\end{center}
...
\zzz{MOS current mirrors}
\\
\begin{minipage}{0.49\columnwidth}
\includegraphics[width=\columnwidth]{../ecen325/current_mirror_nmos.png}
\begin{center}
\vspace{-10px}
\textbf{NMOS}
\end{center}
\end{minipage}
\begin{minipage}{0.49\columnwidth}
\includegraphics[width=\columnwidth]{../ecen325/current_mirror_pmos.png}
\begin{center}
\vspace{-10px}
\textbf{PMOS}
\end{center}
